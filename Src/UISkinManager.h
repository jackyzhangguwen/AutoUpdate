...
public:
	...
	// 以渐变方式填充矩形
	static void GradientFillRect(CWnd* pWnd, 
								CDC* pDC, 
								CRect& rcFill, 
								ULONG nMode, 
								COLORREF crLeftTop, 
	...
	// 透明拉伸复制
	static void TransparentBlt(HDC hdcDest, 
							int nXDest, 
							int nYDest, 
							int nWidthDest, 
							int nHeightDest, 
	...
	// 绘制对话框
	static void Paint(CWnd* pWnd, 
					CDC* pDC = NULL, 
					BOOL bFillClient = TRUE, 
					COLORREF crFillColor = RGB(255, 255, 255));

	static void Paint_Normal(CWnd* pWnd, 
							CDC* pDC = NULL, 
							BOOL bFillClient = TRUE, 
							COLORREF crFillColor = RGB(255, 255, 255));

	static void Paint_XP(CWnd* pWnd, 
						CDC* pDC = NULL, 
						BOOL bFillClient = TRUE, 
						COLORREF crFillColor = RGB(255, 255, 255));

	static void PaintDialogBorder(CWnd* pWnd, 
								CDC* pDC = NULL);

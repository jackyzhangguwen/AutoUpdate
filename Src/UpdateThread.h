...
// Attributes
public:
	CString m_strConfigFileName;			// 升级配置文件名
...
private:
	// 下载文件
	BOOL DownloadFile(CString& strFileSection);
	// 校验文件
	BOOL VerifyFile(CString &strFileSection);
	// 更新文件
	BOOL UpdateFile(CString &strFileSection);
};
